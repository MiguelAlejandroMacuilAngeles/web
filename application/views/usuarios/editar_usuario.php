	            ...
	            <div class="main-content">
	                <div class="section__content section__content--p30">
										<div class="container-fluid">
											...
											<!-- /.container-fluid -->
											<?=form_open('Usuarios/editar_usuarios/'. $usuario->IDUsuario)?>
											<div class="row">
												<div class="col-lg-6">
													<div class="card shadow">
														...
														<div class="form-group col-md-12">
															...
															<input type="text" name="nombre" class="form-control" placeholder=""
																value="<?php echo $usuario->Nombre;?>" <?=form_error('nombre')?>>
														</div>
														<div class="form-group col-md-12">
															<label>Apellido paterno</label>
															<input type="text" name="apellido_paterno" class="form-control"
																value="<?php echo $usuario->apellidoPaterno;?>"
														...
														<div class="form-group col-md-12">
															...
															<input type="text" name="apellido_materno" class="form-control"
																value="<?php echo $usuario->apellidoMaterno;?>"
														...
														<div class="col-12 col-md-6">
															<div class="form-group">
																...
																<select name="area" class="form-control m-b">
																	<option><?php echo $usuario->Area; ?></option>
														...
														<div class="col-12 col-md-6">
															<div class="form-group">
																...
																<select name="puesto" class="form-control m-b">
																	<option><?php echo $usuario->Puesto;?></option>
													...
													<div class="card shadow">
														...
														<div class="form-group col-md-12">
															...
															<select name="tipoUsuario" class="form-control m-b">
																<option><?php echo $usuario->tipoUsuario;?></option>
																<option>pro</option>
														...
														<div class="form-group col-md-12">
															...
															<select name="grupoTrabajo" class="form-control m-b">
																<option><?php echo $usuario->grupoTrabajo;?></option>
														...
														<div class="form-group col-md-12">
															...
															<input type="email" name="correo" class="form-control"
																placeholder="example@gmail.com" value="<?php echo $usuario->correo;?>"
																<?=form_error('Correo')?>>
														</div>
														<div class="form-group col-md-12">
															<label>Contraseña</label>
															<input type="password" name="contrasena" class="form-control"
																value="<?php echo $usuario->contrasena;?>" <?=form_error('contrasena')?>>
														</div>
													</div>
													<div class="my-2"></div>
													<div class="form-group">
